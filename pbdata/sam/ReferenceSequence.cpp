...
void SAMReferenceSequence::StoreValues(std::vector<SAMKeywordValuePair>& kvPairs,
                                       uint64_t lineNumber)
{
    (void)(lineNumber);
...
const char* SAMFullReferenceSequence::SAMFullReferenceSequenceFieldNames[] = {"AS", "M5", "SP",
                                                                              "UR"};
