...
public:
    ...
    int SetScore(int _score) { return (score = _score); }

    int GetScore() { return score; }

    ChainedFragment *SetChainPrev(ChainedFragment *_chainPrev) { return (chainPrev = _chainPrev); }

    ChainedFragment *GetChainPrev() { return chainPrev; }
