...
int QualityValueScoreFunction<T_RefSequence, T_QuerySequence>::Deletion(T_RefSequence &seq,
                                                                        DNALength refPos,
...
template <typename T_RefSequence, typename T_QuerySequence>
int QualityValueScoreFunction<T_RefSequence, T_QuerySequence>::Match(T_RefSequence &ref,
                                                                     DNALength refPos,
...
template <typename T_RefSequence, typename T_QuerySequence>
int QualityValueScoreFunction<T_RefSequence, T_QuerySequence>::Insertion(T_RefSequence &ref,
                                                                         DNALength refPos,
                                                                         T_QuerySequence &seq,
                                                                         DNALength pos)
{
...
template <typename T_RefSequence, typename T_QuerySequence>
int QualityValueScoreFunction<T_RefSequence, T_QuerySequence>::Insertion(T_QuerySequence &seq,
                                                                         DNALength pos)
{
    PB_UNUSED(seq);
    PB_UNUSED(pos);
