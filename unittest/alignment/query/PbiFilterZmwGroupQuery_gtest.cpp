...
static void TestPbiFilterZmwGroupQuery(const string& fn, const vector<size_t>& expected,
                                       const uint32_t min_zmw, const uint32_t max_zmw)
{
    EXPECT_NO_THROW({
...
static void TestNoneConstPbiFilterZmwGroupQuery(const string& fn, const vector<size_t>& expected,
                                                const uint32_t min_zmw, const uint32_t max_zmw)
{
    EXPECT_NO_THROW({
        PbiFilterZmwGroupQuery qQuery(fn);
